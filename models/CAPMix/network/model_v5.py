...
class base_Model(nn.Module):
    def __init__(self, configs, device):
        ...
        self.conv_block1 = nn.Sequential(
            Conv1d(self.input_channels, 32, kernel_size=self.kernel_size,
        ...
        self.conv_block2 = nn.Sequential(
            Conv1d(32, 64, kernel_size=8, stride=1, bias=False, padding=4),
            nn.BatchNorm1d(64),
            nn.ReLU(),
            nn.MaxPool1d(kernel_size=2, stride=2, padding=1)
        )
        ...
        self.conv_block3 = nn.Sequential(
            Conv1d(64, self.final_out_channels, kernel_size=8, stride=1, bias=False, padding=4),
        ...
        # )
        self.seq_projection = Conv1d(self.final_out_channels, 1, 1)
        # nn.init.zeros_(self.seq_projection.weight)
        self.logits = nn.Linear(self.features_len, 2)
